...
.p-theme-dark-experimental{color-scheme:dark;--p-color-bg:rgba(26, 26, 26, 1);--p-color-bg-surface:rgba(48, 48, 48, 1);--p-color-bg-fill:rgba(48, 48, 48, 1);--p-color-icon:rgba(227, 227, 227, 1);--p-color-icon-secondary:rgba(138, 138, 138, 1);--p-color-text:rgba(227, 227, 227, 1);--p-color-text-secondary:rgba(181, 181, 181, 1);--p-color-bg-surface-secondary-active:rgba(255, 255, 255, 0.14);--p-color-bg-surface-secondary-hover:rgba(255, 255, 255, 0.06);--p-color-bg-fill-transparent:rgba(255, 255, 255, 0.11);--p-color-bg-fill-brand:rgba(255, 255, 255, 1);--p-color-text-brand-on-bg-fill:rgba(48, 48, 48, 1);--p-color-bg-surface-hover:rgba(74, 74, 74, 1);--p-color-bg-fill-hover:rgba(37, 37, 37, 1);--p-color-bg-fill-transparent-hover:rgba(255, 255, 255, 0.14);--p-color-bg-fill-brand-hover:rgba(243, 243, 243, 1);--p-color-bg-surface-selected:rgba(97, 97, 97, 1);--p-color-bg-fill-selected:rgba(97, 97, 97, 1);--p-color-bg-fill-transparent-selected:rgba(255, 255, 255, 0.22);--p-color-bg-fill-brand-selected:rgba(212, 212, 212, 1);--p-color-bg-surface-active:rgba(97, 97, 97, 1);--p-color-bg-fill-active:rgba(97, 97, 97, 1);--p-color-bg-fill-transparent-active:rgba(255, 255, 255, 0.17);--p-color-bg-fill-brand-active:rgba(247, 247, 247, 1);--p-color-bg-fill-secondary-hover:rgba(255, 255, 255, 0.11);--p-color-bg-surface-brand-selected:rgba(74, 74, 74, 1);--p-color-border-secondary:rgba(74, 74, 74, 1);--p-color-tooltip-tail-down-border-experimental:rgba(60, 60, 60, 1);--p-color-tooltip-tail-up-border-experimental:rgba(71, 71, 71, 1);--p-color-border-gradient-experimental:linear-gradient(to bottom, rgba(255, 255, 255, 0.17), rgba(255, 255, 255, 0.04));--p-color-border-gradient-hover-experimental:linear-gradient(to bottom, rgba(255, 255, 255, 0.17), rgba(255, 255, 255, 0.04));--p-color-border-gradient-selected-experimental:linear-gradient(to bottom, rgba(0, 0, 0, 0.90), rgba(0, 0, 0, 0.29) 10%, rgba(255, 255, 255, 0.22));--p-color-border-gradient-active-experimental:linear-gradient(to bottom, rgba(0, 0, 0, 0.90), rgba(0, 0, 0, 0.29) 10%, rgba(255, 255, 255, 0.22));--p-color-button-gradient-bg-fill-selected-experimental:linear-gradient(to bottom, rgba(25, 25, 25, 1), rgba(19, 19, 19, 1) 50%, rgba(10, 10, 10, 1));--p-color-button-gradient-bg-fill-active-experimental:linear-gradient(to bottom, rgba(33, 33, 33, 1), rgba(30, 30, 30, 1) 50%, rgba(18, 18, 18, 1));--p-shadow-bevel-100:0.0625rem 0rem 0rem 0rem rgba(204, 204, 204, 0.08) inset, -0.0625rem 0rem 0rem 0rem rgba(204, 204, 204, 0.08) inset, 0rem -0.0625rem 0rem 0rem rgba(204, 204, 204, 0.08) inset, 0rem 0.0625rem 0rem 0rem rgba(204, 204, 204, 0.16) inset;}
...
.Polaris-Frame__hasSidebar--topBarAndReframe{
...
.Polaris-Frame__Frame--topBarAndReframe{
...
.Polaris-Frame__Main--topBarAndReframe{
...
.Polaris-Frame--hasTopBar .Polaris-Frame__Main--topBarAndReframe{
...
.Polaris-Frame__Content--topBarAndReframe{
  height:100%;
}

@media screen and (min-width: 1200px){

.Polaris-Frame--hasSidebar .Polaris-Frame__Content--topBarAndReframe{
      margin-right:unset;
  }
    }
...
.Polaris-Frame__ScrollbarSafeArea--topBarAndReframe{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
...
.Polaris-Frame--hasSidebar .Polaris-Frame__ScrollbarSafeArea--topBarAndReframe{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
  }
...
.Polaris-Frame__ShadowBevel::before {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
...
.Polaris-Frame--hasSidebar .Polaris-Frame__ShadowBevel{
    transition:width var(--p-motion-duration-250) var(--p-motion-ease);
  }
...
.Polaris-Frame__Scrollable:hover{
    scrollbar-color:var(--p-color-scrollbar-thumb-bg-hover) transparent;
  }

.Polaris-Frame__Scrollable--scrollbarAlwaysVisible::-webkit-scrollbar{
    width:0.6875rem;
    background-color:var(--p-color-bg);
  }

.Polaris-Frame__Scrollable--scrollbarAlwaysVisible::-webkit-scrollbar-thumb{
...
.Polaris-Frame__Scrollable--scrollbarAlwaysVisible::-webkit-scrollbar-thumb:hover{
      background-color:var(--p-color-scrollbar-thumb-bg-hover);
    }
...
.Polaris-Navigation__NavigationFrame--topBarAndReframe{
  border-top-left-radius:var(--p-border-radius-300);
  border-top-right-radius:var(--p-border-radius-300);
  margin-top:var(--pg-top-bar-height);
}
...
.Polaris-Navigation__PrimaryNavigation--topBarAndReframe{
